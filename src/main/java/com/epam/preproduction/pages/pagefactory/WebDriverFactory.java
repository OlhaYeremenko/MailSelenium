	...
	public WebDriver getDriver(String parameter) {
		...
		case "ie":
			System.setProperty("webdriver.ie.driver",
					"..\\MailSelenium\\src\\test\\resources\\drivers\\IEDriverServer32.exe");
			return new InternetExplorerDriver();
		case "opera":
			System.setProperty("webdriver.opera.driver",
					"..\\MailSelenium\\src\\test\\resources\\drivers\\operadriver64.exe");
			return new OperaDriver();
		case "chrome":
			System.setProperty("webdriver.chrome.driver",
					"..\\MailSelenium\\src\\test\\resources\\drivers\\chromedriver.exe");
